...
def generate_rag_response(query, retrieved_sections):
    """Генерирует ответ с полными разделами."""
    ...
    for section in retrieved_sections:
        response.append(
            ...
            f"Средняя релевантность: {section['avg_similarity']:.3f}\n"
            f"Количество предложений: {section['sentence_count']}\n\n"
            f"{section['content']}\n"
        )
